...
* **Estruturas de Dados:** `LinkedList` para explorar camada por camada, e `HashMap` para rastrear quem descobriu quem (Backtracking) e reconstruir a rota com alta performance $O(1)$.
